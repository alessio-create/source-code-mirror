...
const services = [
  { icon: Users, title: "Separazioni e Divorzi", description: "Assistenza legale nelle procedure di separazione consensuale e giudiziale, divorzio e negoziazione assistita." },
  { icon: Heart, title: "Diritto dei Minori", description: "Affidamento, collocamento e regolamentazione dei rapporti genitori-figli nel superiore interesse del bambino." },
  { icon: Scale, title: "Diritto di Famiglia", description: "Consulenza completa per le questioni legate ai rapporti familiari fra coniugi e fra genitori e figli." },
  { icon: ShieldCheck, title: "Diritto delle Persone", description: "Amministrazione di sostegno, interdizione, inabilitazione e tutela dei diritti fondamentali." },
  { icon: Briefcase, title: "Diritto Civile", description: "Controversie civilistiche con attenzione alle questioni patrimoniali e successorie connesse alla famiglia." },
];
    ...
    <div className="container mx-auto px-4 md:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {services.map((s, i) => (
          <motion.div
            key={s.title}
            className="bg-card p-8 rounded-2xl border border-border group hover:premium-shadow-lg transition-all duration-500 relative overflow-hidden"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
