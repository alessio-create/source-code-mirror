...
const posts = [
  {
    ...
    excerpt: "Le differenze fondamentali tra i due percorsi, i tempi, i costi e quando è possibile optare per la via consensuale.",
  ...
  },
  {
    ...
    excerpt: "Cosa prevede la legge sull'affidamento condiviso, come funziona nella pratica e cosa fare se l'altro genitore non collabora.",
    category: "Minori",
    date: "2 Aprile 2026",
    readTime: "7 min",
  },
  {
    ...
    excerpt: "I criteri utilizzati dal giudice per determinare l'importo dell'assegno e quando è possibile chiederne la modifica.",
    category: "Divorzio",
    date: "25 Marzo 2026",
    readTime: "6 min",
  },
  {
    ...
    excerpt: "Una guida completa alla misura di protezione per le persone fragili, dalla richiesta alla nomina dell'amministratore.",
    category: "Persone",
    date: "18 Marzo 2026",
    readTime: "8 min",
  },
